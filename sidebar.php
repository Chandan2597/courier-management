  <aside class="main-sidebar sidebar-dark-warning elevation-4" style="background-color: #348ceb">
    <div class="dropdown" style="background-color: #348ceb">
   	<a href="./" class="brand-link" style="background-color: #348ceb">
        <?php if($_SESSION['login_type'] == 1): ?>
        <h3 class="text-center p-0 m-0"><b>ADMIN PANEL</b></h3>
        <?php else: ?>
        <h3 class="text-center p-0 m-0"><b>STAFF PANEL</b></h3>
        <?php endif; ?>

    </a>
      
    </div>
    <div class="sidebar pb-4 mb-4" style="background-color: #348ceb">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link nav-edit_branch">
              ...
              <p>
                Branch
                <i class="right fas fa-caret-square-left"></i>
              </p>
            </a>
